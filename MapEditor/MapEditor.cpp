...
CMapEditorApp::CMapEditorApp()
{
	...
	SetAppID(_T("MapEditor.AppID.NoVersion"));
...
BOOL CMapEditorApp::InitInstance()
{
	...
	//加载所有资源
	m_ResMgr.LoadSceneRes();
	m_ResMgr.LoadSpriteRes();
...
void CMapEditorApp::PreLoadState()
{
	...
	GetContextMenuManager()->AddMenu(strName, IDR_POPUP_LAYER);
}
